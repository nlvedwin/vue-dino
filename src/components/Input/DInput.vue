...
const error = computed(() => {
  return props.error ?? formErrors?.value[inputRef.value?.getAttribute('name')]
})
...
<template>
  <label class="d-input d-block">
    <span
      ...
      class="d-mb-2 d-block d-text-sm d-capitalize d-font-semibold"
    >
      {{ label }}
    </span>
